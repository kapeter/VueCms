	    ...
	    <div class="block">
	        <div class="block-header bg-gray-lighter">
                ...
                <ul class="block-options block-options-left">
                    <li>
                        <a href="base_pages_forum_new_topic.html"><i class="fa fa-plus"></i> 新增目录</a>
                    </li>
                </ul>
	        ...
	        <div class="block-content block-content-full">
	            ...
	            <table class="table table-striped table-borderless table-vcenter">
	                <thead>
	                    <tr>
	                        <th colspan="2">文章管理</th>
	                        <th class="text-center hidden-xs hidden-sm" style="width: 100px;">简述</th>
	                        <th class="text-center hidden-xs hidden-sm" style="width: 100px;">文章数</th>
	                        <th class="hidden-xs hidden-sm" style="width: 200px;">最新文章</th>
	                    </tr>
	                </thead>
	                <tbody>
	                    <tr>
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Ashley Welch</a><br>July 23, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Linda Moore</a><br>July 15, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td class="text-center">
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Ashley Welch</a><br>July 21, 2015</span>
	                        </td>
	                    </tr>
	                </tbody>
	            </table>
	            ...
	            <table class="table table-striped table-borderless table-vcenter">
	                ...
	                <tbody>
	                    <tr>
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Ryan Hall</a><br>July 17, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td class="text-center">
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Ryan Hall</a><br>July 23, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td class="text-center">
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Laura Bell</a><br>July 22, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td class="text-center">
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Roger Hart</a><br>July 17, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td class="text-center">
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Ashley Welch</a><br>July 13, 2015</span>
	                        </td>
	                    </tr>
	                </tbody>
	            </table>
	            ...
	            <table class="table table-striped table-borderless table-vcenter">
	                ...
	                <tbody>
	                    <tr>
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Ann Parker</a><br>July 10, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td class="text-center">
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Walter Fox</a><br>July 20, 2015</span>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td class="text-center">
	                        ...
	                        <td class="hidden-xs hidden-sm">
	                            <span class="font-s13">by <a href="base_pages_profile.html">Craig Stone</a><br>July 24, 2015</span>
	                        </td>
	                    </tr>
	                </tbody>
	            </table>
